<?php //8f3999aacb7acb30d24db7359384df61
/** @noinspection all */
...
namespace LaravelIdea\Helper {
     ...
     * @method $this unionAll(\Closure|Builder|QueryBuilder $query)
     ...
     * @method $this orderBy(\Closure|Builder|QueryBuilder|Expression|string $column, string $direction = 'asc')
     ...
     * @method $this rightJoinSub(\Closure|Builder|QueryBuilder|string $query, string $as, \Closure|string $first, null|string $operator = null, null|string $second = null)
     ...
     * @method int insertUsing(array $columns, \Closure|Builder|QueryBuilder|string $query)
     ...
     * @method $this union(\Closure|Builder|QueryBuilder $query, bool $all = false)
     ...
     * @method $this joinSub(\Closure|Builder|QueryBuilder|string $query, string $as, \Closure|string $first, null|string $operator = null, null|string $second = null, string $type = 'inner', bool $where = false)
     * @see \Illuminate\Database\Query\Builder::selectSub
     * @method $this selectSub(\Closure|Builder|QueryBuilder|string $query, string $as)
     ...
     * @method $this addNestedHavingQuery(QueryBuilder $query, string $boolean = 'and')
     ...
     * @method $this fromSub(\Closure|Builder|QueryBuilder|string $query, string $as)
     ...
     * @method $this orderByDesc(\Closure|Builder|QueryBuilder|Expression|string $column)
     ...
     * @method BuildsQueries|Model|null|object first(array|string $columns = ['*'])
     ...
     * @method $this mergeBindings(QueryBuilder $query)
     ...
     * @method $this leftJoinSub(\Closure|Builder|QueryBuilder|string $query, string $as, \Closure|string $first, null|string $operator = null, null|string $second = null)
     ...
     * @method $this crossJoinSub(\Closure|Builder|QueryBuilder|string $query, string $as)
     * @see \Illuminate\Database\Query\Builder::limit
     * @method $this limit(int $value)
     * @see \Illuminate\Database\Query\Builder::from
     * @method $this from(\Closure|Builder|QueryBuilder|string $table, null|string $as = null)
     ...
     * @method $this addNestedWhereQuery(QueryBuilder $query, string $boolean = 'and')
     ...
     * @method $this reorder(\Closure|QueryBuilder|Expression|null|string $column = null, string $direction = 'asc')
     ...
     * @method QueryBuilder dump()
     * @see \Illuminate\Database\Query\Builder::addWhereExistsQuery
     * @method $this addWhereExistsQuery(QueryBuilder $query, string $boolean = 'and', bool $not = false)
