<?php //26f031e8698f271b5cbd3f60e8205ab6
/** @noinspection all */
...
namespace LaravelIdea\Helper\App\Models\Translation {
     ...
     * @method _IH_BlogCategoryTranslation_QB whereSubtitle($value)
     ...
     * @method _IH_BlogTranslation_QB whereSubtitle($value)
     ...
     * @method _IH_BundleTranslation_QB whereSummary($value)
     ...
     * @method _IH_CategoryTranslation_QB whereSubtitle($value)
     * @method _IH_CategoryTranslation_QB whereBottomSeoTitle($value)
     * @method _IH_CategoryTranslation_QB whereBottomSeoContent($value)
     ...
     * @method _IH_FormTranslation_QB whereSubtitle($value)
    ...
    /**
     * @method ForumRecommendedTopicTranslation|null getOrPut($key, $value)
     * @method ForumRecommendedTopicTranslation|$this shift(int $count = 1)
     * @method ForumRecommendedTopicTranslation|null firstOrFail(callable|string $key = null, $operator = null, $value = null)
     * @method ForumRecommendedTopicTranslation|$this pop(int $count = 1)
     * @method ForumRecommendedTopicTranslation|null pull($key, \Closure $default = null)
     * @method ForumRecommendedTopicTranslation|null last(callable $callback = null, \Closure $default = null)
     * @method ForumRecommendedTopicTranslation|$this random(callable|int|null $number = null)
     * @method ForumRecommendedTopicTranslation|null sole(callable|string $key = null, $operator = null, $value = null)
     * @method ForumRecommendedTopicTranslation|null get($key, \Closure $default = null)
     * @method ForumRecommendedTopicTranslation|null first(callable $callback = null, \Closure $default = null)
     * @method ForumRecommendedTopicTranslation|null firstWhere(callable|string $key, $operator = null, $value = null)
     * @method ForumRecommendedTopicTranslation|null find($key, $default = null)
     * @method ForumRecommendedTopicTranslation[] all()
     */
    class _IH_ForumRecommendedTopicTranslation_C extends _BaseCollection {
        /**
         * @param int $size
         * @return ForumRecommendedTopicTranslation[][]|Collection<_IH_ForumRecommendedTopicTranslation_C>
         */
        public function chunk($size)
        {
            return [];
    ...
    /**
     * @method _IH_ForumRecommendedTopicTranslation_QB whereId($value)
     * @method _IH_ForumRecommendedTopicTranslation_QB whereForumRecommendedTopicId($value)
     * @method _IH_ForumRecommendedTopicTranslation_QB whereLocale($value)
     * @method _IH_ForumRecommendedTopicTranslation_QB whereTitle($value)
     * @method _IH_ForumRecommendedTopicTranslation_QB whereSubtitle($value)
     * @method ForumRecommendedTopicTranslation baseSole(array|string $columns = ['*'])
     * @method ForumRecommendedTopicTranslation create(array $attributes = [])
     * @method _IH_ForumRecommendedTopicTranslation_C|ForumRecommendedTopicTranslation[] cursor()
     * @method ForumRecommendedTopicTranslation|null|_IH_ForumRecommendedTopicTranslation_C|ForumRecommendedTopicTranslation[] find($id, array|string $columns = ['*'])
     * @method _IH_ForumRecommendedTopicTranslation_C|ForumRecommendedTopicTranslation[] findMany(array|Arrayable $ids, array|string $columns = ['*'])
     * @method ForumRecommendedTopicTranslation|_IH_ForumRecommendedTopicTranslation_C|ForumRecommendedTopicTranslation[] findOr($id, array|\Closure|string $columns = ['*'], \Closure $callback = null)
     * @method ForumRecommendedTopicTranslation|_IH_ForumRecommendedTopicTranslation_C|ForumRecommendedTopicTranslation[] findOrFail($id, array|string $columns = ['*'])
     * @method ForumRecommendedTopicTranslation|_IH_ForumRecommendedTopicTranslation_C|ForumRecommendedTopicTranslation[] findOrNew($id, array|string $columns = ['*'])
     * @method ForumRecommendedTopicTranslation first(array|string $columns = ['*'])
     * @method ForumRecommendedTopicTranslation firstOr(array|\Closure|string $columns = ['*'], \Closure $callback = null)
     * @method ForumRecommendedTopicTranslation firstOrCreate(array $attributes = [], array $values = [])
     * @method ForumRecommendedTopicTranslation firstOrFail(array|string $columns = ['*'])
     * @method ForumRecommendedTopicTranslation firstOrNew(array $attributes = [], array $values = [])
     * @method ForumRecommendedTopicTranslation firstWhere(array|\Closure|Expression|string $column, $operator = null, $value = null, string $boolean = 'and')
     * @method ForumRecommendedTopicTranslation forceCreate(array $attributes)
     * @method _IH_ForumRecommendedTopicTranslation_C|ForumRecommendedTopicTranslation[] fromQuery(string $query, array $bindings = [])
     * @method _IH_ForumRecommendedTopicTranslation_C|ForumRecommendedTopicTranslation[] get(array|string $columns = ['*'])
     * @method ForumRecommendedTopicTranslation getModel()
     * @method ForumRecommendedTopicTranslation[] getModels(array|string $columns = ['*'])
     * @method _IH_ForumRecommendedTopicTranslation_C|ForumRecommendedTopicTranslation[] hydrate(array $items)
     * @method _IH_ForumRecommendedTopicTranslation_C|ForumRecommendedTopicTranslation[] lazy(int $chunkSize = 1000)
     * @method _IH_ForumRecommendedTopicTranslation_C|ForumRecommendedTopicTranslation[] lazyById(int $chunkSize = 1000, null|string $column = null, null|string $alias = null)
     * @method _IH_ForumRecommendedTopicTranslation_C|ForumRecommendedTopicTranslation[] lazyByIdDesc(int $chunkSize = 1000, null|string $column = null, null|string $alias = null)
     * @method ForumRecommendedTopicTranslation make(array $attributes = [])
     * @method ForumRecommendedTopicTranslation newModelInstance(array $attributes = [])
     * @method LengthAwarePaginator|ForumRecommendedTopicTranslation[]|_IH_ForumRecommendedTopicTranslation_C paginate(\Closure|int|null $perPage = null, array|string $columns = ['*'], string $pageName = 'page', int|null $page = null)
     * @method ForumRecommendedTopicTranslation restoreOrCreate(array $attributes = [], array $values = [])
     * @method Paginator|ForumRecommendedTopicTranslation[]|_IH_ForumRecommendedTopicTranslation_C simplePaginate(int|null $perPage = null, array|string $columns = ['*'], string $pageName = 'page', int|null $page = null)
     * @method ForumRecommendedTopicTranslation sole(array|string $columns = ['*'])
     * @method ForumRecommendedTopicTranslation updateOrCreate(array $attributes, array $values = [])
     */
    class _IH_ForumRecommendedTopicTranslation_QB extends _BaseBuilder {}
    ...
    /**
     * @method LandingComponentTranslation|null getOrPut($key, $value)
     * @method LandingComponentTranslation|$this shift(int $count = 1)
     * @method LandingComponentTranslation|null firstOrFail(callable|string $key = null, $operator = null, $value = null)
     * @method LandingComponentTranslation|$this pop(int $count = 1)
     * @method LandingComponentTranslation|null pull($key, \Closure $default = null)
     * @method LandingComponentTranslation|null last(callable $callback = null, \Closure $default = null)
     * @method LandingComponentTranslation|$this random(callable|int|null $number = null)
     * @method LandingComponentTranslation|null sole(callable|string $key = null, $operator = null, $value = null)
     * @method LandingComponentTranslation|null get($key, \Closure $default = null)
     * @method LandingComponentTranslation|null first(callable $callback = null, \Closure $default = null)
     * @method LandingComponentTranslation|null firstWhere(callable|string $key, $operator = null, $value = null)
     * @method LandingComponentTranslation|null find($key, $default = null)
     * @method LandingComponentTranslation[] all()
     */
    class _IH_LandingComponentTranslation_C extends _BaseCollection {
        /**
         * @param int $size
         * @return LandingComponentTranslation[][]|Collection<_IH_LandingComponentTranslation_C>
         */
        public function chunk($size)
        {
            return [];
    ...
    /**
     * @method _IH_LandingComponentTranslation_QB whereId($value)
     * @method _IH_LandingComponentTranslation_QB whereLandingComponentId($value)
     * @method _IH_LandingComponentTranslation_QB whereLocale($value)
     * @method _IH_LandingComponentTranslation_QB whereContent($value)
     * @method LandingComponentTranslation baseSole(array|string $columns = ['*'])
     * @method LandingComponentTranslation create(array $attributes = [])
     * @method _IH_LandingComponentTranslation_C|LandingComponentTranslation[] cursor()
     * @method LandingComponentTranslation|null|_IH_LandingComponentTranslation_C|LandingComponentTranslation[] find($id, array|string $columns = ['*'])
     * @method _IH_LandingComponentTranslation_C|LandingComponentTranslation[] findMany(array|Arrayable $ids, array|string $columns = ['*'])
     * @method LandingComponentTranslation|_IH_LandingComponentTranslation_C|LandingComponentTranslation[] findOr($id, array|\Closure|string $columns = ['*'], \Closure $callback = null)
     * @method LandingComponentTranslation|_IH_LandingComponentTranslation_C|LandingComponentTranslation[] findOrFail($id, array|string $columns = ['*'])
     * @method LandingComponentTranslation|_IH_LandingComponentTranslation_C|LandingComponentTranslation[] findOrNew($id, array|string $columns = ['*'])
     * @method LandingComponentTranslation first(array|string $columns = ['*'])
     * @method LandingComponentTranslation firstOr(array|\Closure|string $columns = ['*'], \Closure $callback = null)
     * @method LandingComponentTranslation firstOrCreate(array $attributes = [], array $values = [])
     * @method LandingComponentTranslation firstOrFail(array|string $columns = ['*'])
     * @method LandingComponentTranslation firstOrNew(array $attributes = [], array $values = [])
     * @method LandingComponentTranslation firstWhere(array|\Closure|Expression|string $column, $operator = null, $value = null, string $boolean = 'and')
     * @method LandingComponentTranslation forceCreate(array $attributes)
     * @method _IH_LandingComponentTranslation_C|LandingComponentTranslation[] fromQuery(string $query, array $bindings = [])
     * @method _IH_LandingComponentTranslation_C|LandingComponentTranslation[] get(array|string $columns = ['*'])
     * @method LandingComponentTranslation getModel()
     * @method LandingComponentTranslation[] getModels(array|string $columns = ['*'])
     * @method _IH_LandingComponentTranslation_C|LandingComponentTranslation[] hydrate(array $items)
     * @method _IH_LandingComponentTranslation_C|LandingComponentTranslation[] lazy(int $chunkSize = 1000)
     * @method _IH_LandingComponentTranslation_C|LandingComponentTranslation[] lazyById(int $chunkSize = 1000, null|string $column = null, null|string $alias = null)
     * @method _IH_LandingComponentTranslation_C|LandingComponentTranslation[] lazyByIdDesc(int $chunkSize = 1000, null|string $column = null, null|string $alias = null)
     * @method LandingComponentTranslation make(array $attributes = [])
     * @method LandingComponentTranslation newModelInstance(array $attributes = [])
     * @method LengthAwarePaginator|LandingComponentTranslation[]|_IH_LandingComponentTranslation_C paginate(\Closure|int|null $perPage = null, array|string $columns = ['*'], string $pageName = 'page', int|null $page = null)
     * @method LandingComponentTranslation restoreOrCreate(array $attributes = [], array $values = [])
     * @method Paginator|LandingComponentTranslation[]|_IH_LandingComponentTranslation_C simplePaginate(int|null $perPage = null, array|string $columns = ['*'], string $pageName = 'page', int|null $page = null)
     * @method LandingComponentTranslation sole(array|string $columns = ['*'])
     * @method LandingComponentTranslation updateOrCreate(array $attributes, array $values = [])
     */
    class _IH_LandingComponentTranslation_QB extends _BaseBuilder {}
    
    /**
     * @method LandingTranslation|null getOrPut($key, $value)
     * @method LandingTranslation|$this shift(int $count = 1)
     * @method LandingTranslation|null firstOrFail(callable|string $key = null, $operator = null, $value = null)
     * @method LandingTranslation|$this pop(int $count = 1)
     * @method LandingTranslation|null pull($key, \Closure $default = null)
     * @method LandingTranslation|null last(callable $callback = null, \Closure $default = null)
     * @method LandingTranslation|$this random(callable|int|null $number = null)
     * @method LandingTranslation|null sole(callable|string $key = null, $operator = null, $value = null)
     * @method LandingTranslation|null get($key, \Closure $default = null)
     * @method LandingTranslation|null first(callable $callback = null, \Closure $default = null)
     * @method LandingTranslation|null firstWhere(callable|string $key, $operator = null, $value = null)
     * @method LandingTranslation|null find($key, $default = null)
     * @method LandingTranslation[] all()
     */
    class _IH_LandingTranslation_C extends _BaseCollection {
        /**
         * @param int $size
         * @return LandingTranslation[][]|Collection<_IH_LandingTranslation_C>
         */
        public function chunk($size)
        {
            return [];
    ...
    /**
     * @method _IH_LandingTranslation_QB whereId($value)
     * @method _IH_LandingTranslation_QB whereLandingId($value)
     * @method _IH_LandingTranslation_QB whereLocale($value)
     * @method _IH_LandingTranslation_QB whereTitle($value)
     * @method LandingTranslation baseSole(array|string $columns = ['*'])
     * @method LandingTranslation create(array $attributes = [])
     * @method _IH_LandingTranslation_C|LandingTranslation[] cursor()
     * @method LandingTranslation|null|_IH_LandingTranslation_C|LandingTranslation[] find($id, array|string $columns = ['*'])
     * @method _IH_LandingTranslation_C|LandingTranslation[] findMany(array|Arrayable $ids, array|string $columns = ['*'])
     * @method LandingTranslation|_IH_LandingTranslation_C|LandingTranslation[] findOr($id, array|\Closure|string $columns = ['*'], \Closure $callback = null)
     * @method LandingTranslation|_IH_LandingTranslation_C|LandingTranslation[] findOrFail($id, array|string $columns = ['*'])
     * @method LandingTranslation|_IH_LandingTranslation_C|LandingTranslation[] findOrNew($id, array|string $columns = ['*'])
     * @method LandingTranslation first(array|string $columns = ['*'])
     * @method LandingTranslation firstOr(array|\Closure|string $columns = ['*'], \Closure $callback = null)
     * @method LandingTranslation firstOrCreate(array $attributes = [], array $values = [])
     * @method LandingTranslation firstOrFail(array|string $columns = ['*'])
     * @method LandingTranslation firstOrNew(array $attributes = [], array $values = [])
     * @method LandingTranslation firstWhere(array|\Closure|Expression|string $column, $operator = null, $value = null, string $boolean = 'and')
     * @method LandingTranslation forceCreate(array $attributes)
     * @method _IH_LandingTranslation_C|LandingTranslation[] fromQuery(string $query, array $bindings = [])
     * @method _IH_LandingTranslation_C|LandingTranslation[] get(array|string $columns = ['*'])
     * @method LandingTranslation getModel()
     * @method LandingTranslation[] getModels(array|string $columns = ['*'])
     * @method _IH_LandingTranslation_C|LandingTranslation[] hydrate(array $items)
     * @method _IH_LandingTranslation_C|LandingTranslation[] lazy(int $chunkSize = 1000)
     * @method _IH_LandingTranslation_C|LandingTranslation[] lazyById(int $chunkSize = 1000, null|string $column = null, null|string $alias = null)
     * @method _IH_LandingTranslation_C|LandingTranslation[] lazyByIdDesc(int $chunkSize = 1000, null|string $column = null, null|string $alias = null)
     * @method LandingTranslation make(array $attributes = [])
     * @method LandingTranslation newModelInstance(array $attributes = [])
     * @method LengthAwarePaginator|LandingTranslation[]|_IH_LandingTranslation_C paginate(\Closure|int|null $perPage = null, array|string $columns = ['*'], string $pageName = 'page', int|null $page = null)
     * @method LandingTranslation restoreOrCreate(array $attributes = [], array $values = [])
     * @method Paginator|LandingTranslation[]|_IH_LandingTranslation_C simplePaginate(int|null $perPage = null, array|string $columns = ['*'], string $pageName = 'page', int|null $page = null)
     * @method LandingTranslation sole(array|string $columns = ['*'])
     * @method LandingTranslation updateOrCreate(array $attributes, array $values = [])
     */
    class _IH_LandingTranslation_QB extends _BaseBuilder {}
     ...
     * @method _IH_PageTranslation_QB whereSubtitle($value)
     ...
     * @method _IH_ProductCategoryTranslation_QB whereSubtitle($value)
     * @method _IH_ProductCategoryTranslation_QB whereBottomSeoTitle($value)
     * @method _IH_ProductCategoryTranslation_QB whereBottomSeoDescription($value)
     ...
     * @method RoleTranslation|null firstOrFail(callable|string $key = null, $operator = null, $value = null)
     * @method RoleTranslation|$this pop(int $count = 1)
     * @method RoleTranslation|null pull($key, \Closure $default = null)
     * @method RoleTranslation|null last(callable $callback = null, \Closure $default = null)
     * @method RoleTranslation|$this random(callable|int|null $number = null)
     * @method RoleTranslation|null sole(callable|string $key = null, $operator = null, $value = null)
     * @method RoleTranslation|null get($key, \Closure $default = null)
     * @method RoleTranslation|null first(callable $callback = null, \Closure $default = null)
     * @method RoleTranslation|null firstWhere(callable|string $key, $operator = null, $value = null)
    ...
    class _IH_RoleTranslation_C extends _BaseCollection {
        /**
         * @param int $size
         * @return RoleTranslation[][]|Collection<_IH_RoleTranslation_C>
         */
        public function chunk($size)
        {
            return [];
    ...
    /**
     * @method _IH_RoleTranslation_QB whereId($value)
     * @method _IH_RoleTranslation_QB whereRoleId($value)
     * @method _IH_RoleTranslation_QB whereLocale($value)
     * @method _IH_RoleTranslation_QB whereCaption($value)
     ...
     * @method RoleTranslation|null|_IH_RoleTranslation_C|RoleTranslation[] find($id, array|string $columns = ['*'])
     * @method _IH_RoleTranslation_C|RoleTranslation[] findMany(array|Arrayable $ids, array|string $columns = ['*'])
     * @method RoleTranslation|_IH_RoleTranslation_C|RoleTranslation[] findOr($id, array|\Closure|string $columns = ['*'], \Closure $callback = null)
     * @method RoleTranslation|_IH_RoleTranslation_C|RoleTranslation[] findOrFail($id, array|string $columns = ['*'])
     * @method RoleTranslation|_IH_RoleTranslation_C|RoleTranslation[] findOrNew($id, array|string $columns = ['*'])
     * @method RoleTranslation first(array|string $columns = ['*'])
     * @method RoleTranslation firstOr(array|\Closure|string $columns = ['*'], \Closure $callback = null)
     * @method RoleTranslation firstOrCreate(array $attributes = [], array $values = [])
     * @method RoleTranslation firstOrFail(array|string $columns = ['*'])
     ...
     * @method _IH_RoleTranslation_C|RoleTranslation[] lazy(int $chunkSize = 1000)
     * @method _IH_RoleTranslation_C|RoleTranslation[] lazyById(int $chunkSize = 1000, null|string $column = null, null|string $alias = null)
     * @method _IH_RoleTranslation_C|RoleTranslation[] lazyByIdDesc(int $chunkSize = 1000, null|string $column = null, null|string $alias = null)
     * @method RoleTranslation make(array $attributes = [])
     * @method RoleTranslation newModelInstance(array $attributes = [])
     * @method LengthAwarePaginator|RoleTranslation[]|_IH_RoleTranslation_C paginate(\Closure|int|null $perPage = null, array|string $columns = ['*'], string $pageName = 'page', int|null $page = null)
     * @method RoleTranslation restoreOrCreate(array $attributes = [], array $values = [])
     * @method Paginator|RoleTranslation[]|_IH_RoleTranslation_C simplePaginate(int|null $perPage = null, array|string $columns = ['*'], string $pageName = 'page', int|null $page = null)
     ...
     * @method _IH_SubscribeTranslation_QB whereSubtitle($value)
    ...
    /**
     * @method ThemeHeaderFooterTranslation|null getOrPut($key, $value)
     * @method ThemeHeaderFooterTranslation|$this shift(int $count = 1)
     * @method ThemeHeaderFooterTranslation|null firstOrFail(callable|string $key = null, $operator = null, $value = null)
     * @method ThemeHeaderFooterTranslation|$this pop(int $count = 1)
     * @method ThemeHeaderFooterTranslation|null pull($key, \Closure $default = null)
     * @method ThemeHeaderFooterTranslation|null last(callable $callback = null, \Closure $default = null)
     * @method ThemeHeaderFooterTranslation|$this random(callable|int|null $number = null)
     * @method ThemeHeaderFooterTranslation|null sole(callable|string $key = null, $operator = null, $value = null)
     * @method ThemeHeaderFooterTranslation|null get($key, \Closure $default = null)
     * @method ThemeHeaderFooterTranslation|null first(callable $callback = null, \Closure $default = null)
     * @method ThemeHeaderFooterTranslation|null firstWhere(callable|string $key, $operator = null, $value = null)
     * @method ThemeHeaderFooterTranslation|null find($key, $default = null)
     * @method ThemeHeaderFooterTranslation[] all()
     */
    class _IH_ThemeHeaderFooterTranslation_C extends _BaseCollection {
        /**
         * @param int $size
         * @return ThemeHeaderFooterTranslation[][]|Collection<_IH_ThemeHeaderFooterTranslation_C>
         */
        public function chunk($size)
        {
            return [];
    ...
    /**
     * @method _IH_ThemeHeaderFooterTranslation_QB whereId($value)
     * @method _IH_ThemeHeaderFooterTranslation_QB whereThemeHeaderFooterId($value)
     * @method _IH_ThemeHeaderFooterTranslation_QB whereLocale($value)
     * @method _IH_ThemeHeaderFooterTranslation_QB whereTitle($value)
     * @method _IH_ThemeHeaderFooterTranslation_QB whereContent($value)
     * @method ThemeHeaderFooterTranslation baseSole(array|string $columns = ['*'])
     * @method ThemeHeaderFooterTranslation create(array $attributes = [])
     * @method _IH_ThemeHeaderFooterTranslation_C|ThemeHeaderFooterTranslation[] cursor()
     * @method ThemeHeaderFooterTranslation|null|_IH_ThemeHeaderFooterTranslation_C|ThemeHeaderFooterTranslation[] find($id, array|string $columns = ['*'])
     * @method _IH_ThemeHeaderFooterTranslation_C|ThemeHeaderFooterTranslation[] findMany(array|Arrayable $ids, array|string $columns = ['*'])
     * @method ThemeHeaderFooterTranslation|_IH_ThemeHeaderFooterTranslation_C|ThemeHeaderFooterTranslation[] findOr($id, array|\Closure|string $columns = ['*'], \Closure $callback = null)
     * @method ThemeHeaderFooterTranslation|_IH_ThemeHeaderFooterTranslation_C|ThemeHeaderFooterTranslation[] findOrFail($id, array|string $columns = ['*'])
     * @method ThemeHeaderFooterTranslation|_IH_ThemeHeaderFooterTranslation_C|ThemeHeaderFooterTranslation[] findOrNew($id, array|string $columns = ['*'])
     * @method ThemeHeaderFooterTranslation first(array|string $columns = ['*'])
     * @method ThemeHeaderFooterTranslation firstOr(array|\Closure|string $columns = ['*'], \Closure $callback = null)
     * @method ThemeHeaderFooterTranslation firstOrCreate(array $attributes = [], array $values = [])
     * @method ThemeHeaderFooterTranslation firstOrFail(array|string $columns = ['*'])
     * @method ThemeHeaderFooterTranslation firstOrNew(array $attributes = [], array $values = [])
     * @method ThemeHeaderFooterTranslation firstWhere(array|\Closure|Expression|string $column, $operator = null, $value = null, string $boolean = 'and')
     * @method ThemeHeaderFooterTranslation forceCreate(array $attributes)
     * @method _IH_ThemeHeaderFooterTranslation_C|ThemeHeaderFooterTranslation[] fromQuery(string $query, array $bindings = [])
     * @method _IH_ThemeHeaderFooterTranslation_C|ThemeHeaderFooterTranslation[] get(array|string $columns = ['*'])
     * @method ThemeHeaderFooterTranslation getModel()
     * @method ThemeHeaderFooterTranslation[] getModels(array|string $columns = ['*'])
     * @method _IH_ThemeHeaderFooterTranslation_C|ThemeHeaderFooterTranslation[] hydrate(array $items)
     * @method _IH_ThemeHeaderFooterTranslation_C|ThemeHeaderFooterTranslation[] lazy(int $chunkSize = 1000)
     * @method _IH_ThemeHeaderFooterTranslation_C|ThemeHeaderFooterTranslation[] lazyById(int $chunkSize = 1000, null|string $column = null, null|string $alias = null)
     * @method _IH_ThemeHeaderFooterTranslation_C|ThemeHeaderFooterTranslation[] lazyByIdDesc(int $chunkSize = 1000, null|string $column = null, null|string $alias = null)
     * @method ThemeHeaderFooterTranslation make(array $attributes = [])
     * @method ThemeHeaderFooterTranslation newModelInstance(array $attributes = [])
     * @method LengthAwarePaginator|ThemeHeaderFooterTranslation[]|_IH_ThemeHeaderFooterTranslation_C paginate(\Closure|int|null $perPage = null, array|string $columns = ['*'], string $pageName = 'page', int|null $page = null)
     * @method ThemeHeaderFooterTranslation restoreOrCreate(array $attributes = [], array $values = [])
     * @method Paginator|ThemeHeaderFooterTranslation[]|_IH_ThemeHeaderFooterTranslation_C simplePaginate(int|null $perPage = null, array|string $columns = ['*'], string $pageName = 'page', int|null $page = null)
     * @method ThemeHeaderFooterTranslation sole(array|string $columns = ['*'])
     * @method ThemeHeaderFooterTranslation updateOrCreate(array $attributes, array $values = [])
     */
    class _IH_ThemeHeaderFooterTranslation_QB extends _BaseBuilder {}
     ...
     * @method _IH_UpcomingCourseTranslation_QB whereSummary($value)
     ...
     * @method _IH_WebinarTranslation_QB whereSummary($value)
